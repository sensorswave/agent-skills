...
After choosing a route, stop using this file and follow the target skill. If no route is clear, ask one concise question: "你现在要做埋点落地、质检、数据分析、看板构建、产品帮助，还是 Catalog 元数据治理？"
